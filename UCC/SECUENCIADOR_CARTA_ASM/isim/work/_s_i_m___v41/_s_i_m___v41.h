...
#ifndef H_workM_s_i_m___v41_H
#define H_workM_s_i_m___v41_H
...
class workM_s_i_m___v41 : public HSim__s5{
public: 
    workM_s_i_m___v41(const char *instname);
    ~workM_s_i_m___v41();
    void setDefparam();
