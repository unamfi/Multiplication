...
#ifndef H_workM_s_i_m___v40_H
#define H_workM_s_i_m___v40_H
...
class workM_s_i_m___v40 : public HSim__s5{
public: 
    workM_s_i_m___v40(const char *instname);
    ~workM_s_i_m___v40();
    void setDefparam();
