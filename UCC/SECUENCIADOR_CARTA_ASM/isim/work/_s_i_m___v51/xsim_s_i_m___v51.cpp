#include "isim/work/_s_i_m___v51/_s_i_m___v51.h"
...
#include "work/_s_i_m___v51/_s_i_m___v51.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workM_s_i_m___v51(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("SIM_V51", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        topvl = new workM_s_i_m___v51("SIM_V51");
