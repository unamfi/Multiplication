...
#ifndef H_workM_s_i_m___v51_H
#define H_workM_s_i_m___v51_H
...
class workM_s_i_m___v51 : public HSim__s5{
public: 
    workM_s_i_m___v51(const char *instname);
    ~workM_s_i_m___v51();
    void setDefparam();
