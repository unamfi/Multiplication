...
#ifndef H_workM_s_i_m___v50_H
#define H_workM_s_i_m___v50_H
...
class workM_s_i_m___v50 : public HSim__s5{
public: 
    workM_s_i_m___v50(const char *instname);
    ~workM_s_i_m___v50();
    void setDefparam();
