#include "isim/work/_s_i_m___v42/_s_i_m___v42.h"
...
#include "work/_s_i_m___v42/_s_i_m___v42.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workM_s_i_m___v42(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("SIM_V42", (HSimInstFactoryPtr)IF0);
        ...
        (*cfgvh).addVlogModule("contador/behavioral", (HSimInstFactoryPtr)IF20, true);
        (*cfgvh).addVlogModule("alu/behavioral", (HSimInstFactoryPtr)IF21, true);
        (*cfgvh).addVlogModule("ind_fisica/behavioral", (HSimInstFactoryPtr)IF22, true);
        (*cfgvh).addVlogModule("acc/behavioral", (HSimInstFactoryPtr)IF23, true);
        (*cfgvh).addVlogModule("secuenciador", (HSimInstFactoryPtr)IF24, true);
        (*cfgvh).addVlogModule("memoria", (HSimInstFactoryPtr)IF25, true);
        (*cfgvh).addVlogModule("mux_4_1", (HSimInstFactoryPtr)IF26, true);
        (*cfgvh).addVlogModule("logica", (HSimInstFactoryPtr)IF27, true);
        (*cfgvh).addVlogModule("upa_out", (HSimInstFactoryPtr)IF28, true);
        (*cfgvh).addVlogModule("upa_in", (HSimInstFactoryPtr)IF29, true);
        (*cfgvh).addVlogModule("reg_flags", (HSimInstFactoryPtr)IF30, true);
        (*cfgvh).addVlogModule("contador", (HSimInstFactoryPtr)IF31, true);
        (*cfgvh).addVlogModule("alu", (HSimInstFactoryPtr)IF32, true);
        (*cfgvh).addVlogModule("ind_fisica", (HSimInstFactoryPtr)IF33, true);
        (*cfgvh).addVlogModule("acc", (HSimInstFactoryPtr)IF34, true);
        HSim__s5 * topvl = 0;
        topvl = new workM_s_i_m___v42("SIM_V42");
