...
#ifndef H_workM_s_i_m___v42_H
#define H_workM_s_i_m___v42_H
...
class workM_s_i_m___v42 : public HSim__s5{
public: 
    workM_s_i_m___v42(const char *instname);
    ~workM_s_i_m___v42();
    void setDefparam();
