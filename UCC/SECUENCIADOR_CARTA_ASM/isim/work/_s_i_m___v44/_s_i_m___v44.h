...
#ifndef H_workM_s_i_m___v44_H
#define H_workM_s_i_m___v44_H
...
class workM_s_i_m___v44 : public HSim__s5{
public: 
    workM_s_i_m___v44(const char *instname);
    ~workM_s_i_m___v44();
    void setDefparam();
